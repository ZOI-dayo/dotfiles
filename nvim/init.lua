...
require('jetpack.paq') {
  ...
  {'williamboman/mason-lspconfig.nvim', requires={'mason.nvim', 'nvim-lspconfig'}},
  --[[
  ...
  'jghauser/mkdir.nvim',
  {'SmiteshP/nvim-navic', requires='nvim-lspconfig'},
  {'j-hui/fidget.nvim', requires='nvim-lspconfig'}, -- なぜか動かない
...
require('nvim-treesitter.configs').setup {
  ensure_installed = {'vim', 'help', 'lua', 'cpp'},
  sync_install = false,
  highlight = {
    enable = true,
